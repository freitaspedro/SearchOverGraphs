...
def main(file_bfs, file_dfs, file_heu1, file_heu2, file_heu3, file_mods, exit_file):
    ...
    plt.yticks(np.arange(0, max([max(bfs_positives_mean), max(dfs_positives_mean),  max(heu1_positives_mean), max(heu2_positives_mean),
        max(heu3_positives_mean), max(mods_positives_mean)])+201.0, 200.0), fontsize = 9)
...
if __name__ == "__main__":
    ...
    # plot2.py "snap/facebook/1912/f119/BFS.search.csv" "snap/facebook/1912/f119/DFS.search.csv" "snap/facebook/1912/f119/HEU1.search.csv" "snap/facebook/1912/f119/HEU2.search.csv" "snap/facebook/1912/f119/HEU3.search.csv" "snap/facebook/1912/f119/MODs.search.csv" "snap/facebook/1912/f119/s_searchs.png"

    # plot2.py "snap/gplus/116807883656585676940/f0/BFS.search.csv" "snap/gplus/116807883656585676940/f0/DFS.search.csv" "snap/gplus/116807883656585676940/f0/HEU1.search.csv" "snap/gplus/116807883656585676940/f0/HEU2.search.csv" "snap/gplus/116807883656585676940/f0/HEU3.search.csv" "snap/gplus/116807883656585676940/f0/MODs.search.csv" "snap/gplus/116807883656585676940/f0/s_searchs.png"