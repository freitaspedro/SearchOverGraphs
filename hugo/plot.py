...
def main(file_bfs, file_dfs, file_heu1, file_heu2, file_heu3, file_mods, exit_file, bar):
    ...
    plt.yticks(np.arange(0, max([max(bfs_positives_mean), max(dfs_positives_mean),  max(heu1_positives_mean), max(heu2_positives_mean),
        max(heu3_positives_mean), max(mods_positives_mean)])+111111.0, 10.0), fontsize = 7)
...
if __name__ == "__main__":
    ...
    # plot.py "200k_p2p/6s50r/200k_BFS.search.csv" "200k_p2p/6s50r/200k_DFS.search.csv" "200k_p2p/6s50r/200k_HEU1.search.csv" "200k_p2p/6s50r/200k_HEU2.search.csv" "200k_p2p/6s50r/200k_HEU3.search.csv" "200k_p2p/6s50r/200k_MODs.search.csv" "200k_p2p/6s50r/s_searchs.png" no